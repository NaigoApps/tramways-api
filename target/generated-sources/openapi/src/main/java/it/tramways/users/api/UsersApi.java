...
public interface UsersApi {
     ...
     *         or You are not authorized (status code 401)
     */
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK") })
    @RequestMapping(value = "/users/{id}/password",
        consumes = { "application/json" },
     ...
     *
     * @param id  (required)
     * @param itTramwaysCommonsApiModelBooleanWrapper  (optional)
     * @return Ok (status code 200)
     */
    ...
    @RequestMapping(value = "/users/{id}/enable",
        consumes = { "application/json" },
        method = RequestMethod.PUT)
    default ResponseEntity<Void> enableUser(@ApiParam(value = "",required=true) @PathVariable("id") String id,@ApiParam(value = ""  )  @Valid @RequestBody(required = false) it.tramways.commons.api.model.BooleanWrapper itTramwaysCommonsApiModelBooleanWrapper) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 404, message = "User not found", response = it.tramways.commons.api.model.ErrorWrapper.class) })
    @RequestMapping(value = "/users/{id}",
        produces = { "application/json" }, 
    ...
    @RequestMapping(value = "/users/logged",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
     ...
     */
    @ApiOperation(value = "Logs a user in", nickname = "login", notes = "", response = it.tramways.commons.api.model.StringWrapper.class, tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Request successful", response = it.tramways.commons.api.model.StringWrapper.class) })
    @RequestMapping(value = "/users/login",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
    default ResponseEntity<it.tramways.commons.api.model.StringWrapper> login(@ApiParam(value = ""  )  @Valid @RequestBody(required = false) LoginRequest loginRequest) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
     ...
     *
     * @param id  (required)
     * @param itTramwaysCommonsApiModelStringWrapper  (optional)
     * @return OK (status code 200)
     */
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK") })
    @RequestMapping(value = "/users/{id}/reset",
        consumes = { "application/json" },
        method = RequestMethod.PUT)
    default ResponseEntity<Void> resetUser(@ApiParam(value = "",required=true) @PathVariable("id") String id,@ApiParam(value = ""  )  @Valid @RequestBody(required = false) it.tramways.commons.api.model.StringWrapper itTramwaysCommonsApiModelStringWrapper) {
        return new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED);
